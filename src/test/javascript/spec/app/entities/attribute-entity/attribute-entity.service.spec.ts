...
describe('Service Tests', () => {
    describe('AttributeEntity Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AttributeEntityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/attribute-entities';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });

            it('should create a AttributeEntity', () => {
                service.create(new AttributeEntity(null)).subscribe(received => {
            ...
            it('should update a AttributeEntity', () => {
                service.update(new AttributeEntity('123')).subscribe(received => {
            ...
            it('should return a AttributeEntity', () => {
            ...
            it('should return a list of AttributeEntity', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new AttributeEntity('123')]);
            });
